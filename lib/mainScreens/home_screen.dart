    ...
    return Scaffold(
      ...
      appBar: AppBar(
        flexibleSpace: Container(
          // Uygulamanın üst kısmında, arka plan için bir gradient kullanır
        ...
        title: Text(
          // Uygulamanın üst kısmındaki yazı.
        ...
        actions: [
          // Uygulamanın üst kısmında ekle butonu
          IconButton(
            icon: const Icon(
              Icons.post_add,
              color: Colors.cyan,
      ...
      body: CustomScrollView(
        // Ana ekranda bir kaydırılabilir görünüm kullanır
        slivers: [
          SliverPersistentHeader(
              pinned: true,
              delegate: TextWidgetHeader(
                  title: "My Menus")), // Kaydırılabilir başlık bileşeni
          StreamBuilder<QuerySnapshot>(
            // Veritabanından veri almak için bir StreamBuilder kullanır
