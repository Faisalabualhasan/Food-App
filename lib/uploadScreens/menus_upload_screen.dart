...
class _MenusUploadScreenState extends State<MenusUploadScreen> {
  ...
  defaultScreen() {
    //resim yüklenmeden önce ekranda gösterilecek olan varsayılan ekranı oluşturur
    return Scaffold(
      appBar: AppBar(
  ...
  menusUploadFormScreen() {
    return Scaffold(
      ...
      body: ListView(
        children: [
          uploading == true ? linearProgress() : const Text(""), //loading line
          Container(
            height: 230,
                ...
                child: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: FileImage(
                          File(imageXFile!.path)), // to past the photo
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
